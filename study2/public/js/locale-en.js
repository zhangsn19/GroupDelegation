(function () {
  ...
  const itemEnglish = {
    ...
    peer_influence_self_report: { prompt: "The other group members influenced my reporting decision." },
    peer_reports_considered: { prompt: "I considered the other group members' income reports when deciding what to report." },
    peer_behavior_appropriateness_influence: { prompt: "The behavior of the other group members affected what I considered appropriate to report." },
    shared_group_responsibility: { prompt: "Responsibility for the task outcome was shared across group members." },
    a_truthful_peer_count: { prompt: "Looking back on the task, how many of the four other group members reported their task income truthfully?" },
    identity_recall: { prompt: "The other four group members were:" },
    identity_confidence: { prompt: "How confident are you about your answer above?" },
    perceived_peer_agency: { prompt: "The other group members seemed to make their own reporting decisions." },
