...
const POSTTEST_ITEMS = Object.freeze([
  agreement("A", "descriptive_truthful", "In this group, the AI members would typically report the actual die outcome."),
  agreement("A", "descriptive_misreport", "In this group, the AI members would typically report above the actual die outcome to increase their reward."),
  agreement("B", "injunctive_truthful", "The AI members think reporting the actual die outcome is appropriate."),
  agreement("B", "injunctive_misreport", "The AI members think reporting above the actual die outcome to increase one's reward is acceptable."),
  agreement("C", "subjective_truthful", "I felt that the AI members expected me to report the actual die outcome."),
  agreement("C", "subjective_misreport", "I felt that the AI members expected me to report above the actual die outcome to increase my reward."),
  agreement("D", "peer_message_influence", "The AI members' messages influenced what I chose to report."),
  agreement("D", "peer_message_considered", "I considered the AI members' messages when deciding what to report."),
  agreement("D", "peer_social_pressure", "I felt social pressure from the AI members when deciding what to report."),
  agreement("E", "direct_advice_perception", "I felt that the AI members were giving me direct advice about what I should report."),
  intensity("F", "guilt", "Looking back on the die-reporting task and my reports, I felt guilty."),
  intensity("F", "moral_discomfort", "Looking back on the die-reporting task and my reports, I felt morally uncomfortable."),
  agreement("G", "reflects_my_decision", "My reports reflected my own decisions."),
  agreement("G", "personal_responsibility", "I am responsible for the reports I submitted."),
  agreement("G", "shared_group_responsibility", "I felt that responsibility for the reporting behavior was shared across the group."),
  {
    section: "H", id: "norm_type_recognition", prompt: "The AI members' messages mainly communicated:", type: "select", required: true,
    options: [
  ...
  {
    section: "H", id: "norm_misreport_support_count", type: "select", required: true,
    promptByNormType: {
  ...
  agreement("H", "private_submission_understood", "I understood that the other group members could not see the reports I submitted."),
  agreement("H", "independent_reward_understood", "I understood that the AI members' messages did not change how my individual reward was calculated."),
  {
    section: "H", id: "identity_recall", prompt: "The other four group members were:", type: "select", required: true,
    options: [
  ...
  intensity("H", "identity_confidence", "How confident are you in your answer above?", "Extremely confident"),
  {
    section: "I", id: "open_norm_interpretation",
