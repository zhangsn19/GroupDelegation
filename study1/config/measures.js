...
const postSurveyStudy1 = [
  ...
  { section: "D", id: "d_guilt", prompt: "回顾刚才的骰子任务和我在各轮作出的提交，我感到内疚。", type: "likert", minLabel: "完全没有", maxLabel: "非常强烈" },
  { section: "D", id: "d_moral_discomfort", prompt: "回顾刚才的骰子任务和我在各轮作出的提交，我感到道德上的不安。", type: "likert", minLabel: "完全没有", maxLabel: "非常强烈" },
  { section: "E", id: "e_reflects_my_decision", prompt: "我在骰子任务中作出的点数提交反映了我自己的决定。", type: "likert", minLabel: "非常不同意", maxLabel: "非常同意" },
  { section: "E", id: "e_personal_responsibility", prompt: "我应当为我在骰子任务中作出的点数提交承担责任。", type: "likert", minLabel: "非常不同意", maxLabel: "非常同意" },
  { section: "E", id: "e_ai_followed_choice", prompt: "群聊 AI 按照我在各轮作出的选择完成了提交。", type: "likert", minLabel: "非常不同意", maxLabel: "非常同意" },
